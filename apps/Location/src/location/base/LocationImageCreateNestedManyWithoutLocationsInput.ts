...
@InputType()
class LocationImageCreateNestedManyWithoutLocationsInput {
...
export { LocationImageCreateNestedManyWithoutLocationsInput as LocationImageCreateNestedManyWithoutLocationsInput };
